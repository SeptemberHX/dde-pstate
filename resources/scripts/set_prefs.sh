...
json="${json},\"available_gov\":${available_gov}"
json="${json},\"available_energy\":${available_energy}"
...
get_support_energy() {
  energys=`cat /sys/devices/system/cpu/cpu0/cpufreq/energy_performance_available_preferences`
  json="["

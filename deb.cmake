...
set(CPACK_PACKAGE_NAME "dde-pstate")

# 设置程序名，就是程序安装后的名字
 set(CPACK_DEBIAN_PACKAGE_NAME "dde-pstate")
...
# 设置description
set(CPACK_PACKAGE_DESCRIPTION "DDE Pstate is a power related plugin for Deepin V20.2")
...
install(FILES ${CMAKE_BINARY_DIR}/libdde_pstate.so DESTINATION /usr/lib/dde-dock/plugins)
install(FILES ${CMAKE_SOURCE_DIR}/resources/scripts/set_prefs.sh DESTINATION /opt/dde-dock/scripts)
